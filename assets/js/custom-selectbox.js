  ...
  IconSelectBox: function ( img ) {
    ...
    var getStorage = function () {
      ...
      if (lastSelected) {
        ...
        $(prefix_class +'-select-box').html(lastSelected + ' <i data-arrow="true" class="far fa-arrow-down"></i>');
        var val = $(prefix_class +'-select-box').find('[data-value]').data('value');
        
        $(defaultSelect).val(val);
      } else {
        $(prefix_class +'-select-box').html(optionArray[0] + ' <i data-arrow="true" class="far fa-arrow-down"></i>');
    ...
    $(prefix_class +'-a li').click( function() {
      ...
      $(prefix_class +'-select-box').html(item + '<i data-arrow="true" class="far fa-arrow-down"></i>');
    ...
    $(prefix_class +'-select-box').click(function(){
      ...
      if(cls === "far fa-arrow-up") {
          $(this).find('[data-arrow]').attr('class', 'far fa-arrow-down');
      } else {
          $(this).find('[data-arrow]').attr('class', 'far fa-arrow-up');
      }
...
$('#dropOne').IconSelectBox(true);
$('#dropTwo').IconSelectBox(true);
$('#dropThree').IconSelectBox(true);
$('#dropFour').IconSelectBox(true);